 ...
 */
class UpmixMidiController : public juce::MidiInputCallback
{
public:
    UpmixMidiController();
    ~UpmixMidiController() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(UpmixMidiController)
};

...
UpmixMidiController::UpmixMidiController() = default;

UpmixMidiController::~UpmixMidiController()
{
    if (m_midiInput)
    {
        m_midiInput->stop();
...
void UpmixMidiController::openDevice(const juce::String& deviceIdentifier)
{
...
void UpmixMidiController::setAssignment(UmsciExternalControlComponent::UpmixMidiParam param,
                                         const JUCEAppBasics::MidiCommandRangeAssignment& assi)
{
    m_assignments[static_cast<int>(param)] = assi;
}

const JUCEAppBasics::MidiCommandRangeAssignment& UpmixMidiController::getAssignment(
    UmsciExternalControlComponent::UpmixMidiParam param) const
{
    return m_assignments[static_cast<int>(param)];
}

void UpmixMidiController::handleIncomingMidiMessage(juce::MidiInput*,

...
UpmixOscController::UpmixOscController()
{
...
void UpmixOscController::openPort(int port)
{
    if (m_port == port)
        return;
...
void UpmixOscController::setAddress(UmsciExternalControlComponent::UpmixMidiParam param,
                                     const juce::String& address)
{
    m_addresses[static_cast<int>(param)] = address;
}

juce::String UpmixOscController::getAddress(
    UmsciExternalControlComponent::UpmixMidiParam param) const
{
    return m_addresses[static_cast<int>(param)];
}

void UpmixOscController::oscMessageReceived(const juce::OSCMessage& message)
{
